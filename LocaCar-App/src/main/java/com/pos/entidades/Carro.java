...
@NamedQueries({ 
    ...
    @NamedQuery(name = Carro.BUSCAR_TODOS_CARROS_DISPONIVEL_PELO_ID_LOCADORA, query="SELECT c FROM Locadora l, Carro c WHERE c.statusReserva='DISPONIVEL' AND l.id = :id"),
    @NamedQuery(name = Carro.BUSCAR_CARRO_PELO_ID, query="SELECT c FROM Carro c WHERE c.id=:id")
})
